...
Реализовано персистентное хранение логов запросов в базе данных SQLite.
Таблица: RequestLogs

Реализована Docker контейнеризация

Написаны Unit тесты в папке AwesomeFilesApi.Tests

Реализовано кэширование архивов (id процесса разный, но архив остается тот же)